...
return [
     ...
     */
    'debug' => filter_var(env('DEBUG', true), 0/*FILTER_VALIDATE_BOOLEAN*/),
     ...
     */
    'Security' => [
        'salt' => env('SECURITY_SALT', 'f67cb4f491405c9607f09548347408a240cb2af89618205c7cad8c69e42dcd58'),
    ],
    ...
    'EmailTransport' => [
        ...
        'gmail' => [
            ...
            'port' =>  465,
            'username' => 'turbohawkracing@gmail.com',
            'password' => 'tkoflivqllqnzxsv',
            'className' => 'Smtp'
        ],
    ],
    ...
    'Email' => [
        'default' => [
            'transport' => 'gmail',
            'from' => 'turbohawkracing@gmail.com',
            //'charset' => 'utf-8',
            //'headerCharset' => 'utf-8',
        ],
    ],
...
//            'database' => 'turbohawkracingschool',
//            /*
